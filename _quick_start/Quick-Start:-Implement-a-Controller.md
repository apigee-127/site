...
Let's look at an example controller taken from the Weather API sample in the [Apigee-127 samples project](https://github.com/apigee-127/a127-samples) on GitHub.
...
Here is how you call the Weather API, which returns data for a specified city. You can clone the [a127-samples](https://github.com/apigee-127/a127-samples) project and try it out for yourself!
